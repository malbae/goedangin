...
const navigation = [
  ...
  { name: "Konten", href: "/konten", current: true },
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <main className="flex-grow bg-gray-50 p-8 overflow-auto">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-2xl font-bold text-black mb-6">Konten</h1>
          ...
          <div className="mb-4 flex justify-between items-center">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-sm text-black">entries</span>
            </div>
            <div>
          ...
          <table className="table-auto w-full border-collapse border border-gray-300 text-sm text-black">
            <thead>
              <tr className="bg-gray-200">
                ...
                <th className="border border-gray-300 px-4 py-2">Nama Konten</th>
                <th className="border border-gray-300 px-4 py-2">Kategori Konten</th>
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-gray-300 px-4 py-2">Mark</td>
                <td className="border border-gray-300 px-4 py-2">Otto</td>
                <td className="border border-gray-300 px-4 py-2">@mdo</td>
          ...
          <div className="mt-4 flex justify-between items-center">
            <span className="text-sm text-black">Showing 1 to 1 of 1 entries</span>
